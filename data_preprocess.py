...
def txt_to_clean(input_txt, clean_path=None, textmode=False):
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_LawArticles_', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_AmountOfMoney_', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_SpecificDate_', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_SpecificMonth_', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_SecurityID_', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_ADDRESS_', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_AgesYear_', regex=True)
    ...
    df['content'] = df['content'].str.replace(pat=pattern,repl='_SpecificCase_', regex=True)
